...
class CartItemsControllerTest < ActionController::TestCase
  ...
  test "should create cart_item" do
    assert_difference('CartItem.count') do
      post :create, cart_item: { cart_id: @cart_item.cart_id, item_quantity: @cart_item.item_quantity, product_id: @cart_item.product_id, total_price_item: @cart_item.total_price_item }
    end
  ...
  test "should update cart_item" do
    patch :update, id: @cart_item, cart_item: { cart_id: @cart_item.cart_id, item_quantity: @cart_item.item_quantity, product_id: @cart_item.product_id, total_price_item: @cart_item.total_price_item }
    assert_redirected_to cart_item_path(assigns(:cart_item))
  end
